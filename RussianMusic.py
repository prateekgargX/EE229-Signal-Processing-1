...
class RussianMusic(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.fir_filter_xxx_0 = filter.fir_filter_fff(8, [(8)])
        ...
        self.connect((self.fir_filter_xxx_0_0, 0), (self.audio_sink_0, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.fir_filter_xxx_0, 0))
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.fir_filter_xxx_0_0, 0))
