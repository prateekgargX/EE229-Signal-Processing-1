...
class GNU_exp20d070060(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_0_0_0_0.set_y_label('800HZ', "")
        ...
        self.qtgui_time_sink_x_0_0_0_0.set_y_label('400HZ', "")
        ...
        self.qtgui_time_sink_x_0_0_0.set_y_label('650HZ', "")
        ...
        self.qtgui_time_sink_x_0_0.set_y_label('300hz', "")
        ...
        self.qtgui_time_sink_x_0.set_y_label('1000Hz', "")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\prate\\Desktop\\GNU Radio Files\\Signal_20D070060.wav', False)
        ...
        self.analog_sig_source_x_0_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 300, 1, 0, 0)
        self.analog_sig_source_x_0_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 400, 1, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 650, 1, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_sub_xx_0_0_0, 1))
        self.connect((self.analog_sig_source_x_0_0_0, 0), (self.blocks_sub_xx_0_0_0_0, 1))
        self.connect((self.analog_sig_source_x_0_0_0_0, 0), (self.blocks_sub_xx_0_0, 1))
        self.connect((self.analog_sig_source_x_0_0_0_0_0, 0), (self.blocks_sub_xx_0_0_0_0_0, 1))
        self.connect((self.blocks_sub_xx_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.blocks_sub_xx_0_0, 0), (self.qtgui_time_sink_x_0_0, 0))
        self.connect((self.blocks_sub_xx_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.blocks_sub_xx_0_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0, 0))
        self.connect((self.blocks_sub_xx_0_0_0_0_0, 0), (self.qtgui_time_sink_x_0_0_0_0_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.blocks_sub_xx_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.blocks_sub_xx_0_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.blocks_sub_xx_0_0_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.blocks_sub_xx_0_0_0_0, 0))
        self.connect((self.blocks_wavfile_source_0, 0), (self.blocks_sub_xx_0_0_0_0_0, 0))
